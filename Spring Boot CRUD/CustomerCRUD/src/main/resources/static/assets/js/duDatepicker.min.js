! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).duDatepicker = t() }(this, function() {
    "use strict";
    ...
    var E = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
        ...
        D = {
            appendTo: function(e, t, a) { Array.isArray(e) ? e.forEach(function(e) { 0 === a ? t.insertBefore(e, t.childNodes[a] || null) : t.appendChild(e) }) : 0 === a ? t.insertBefore(e, t.childNodes[a] || null) : t.appendChild(e) },
            addEvent: function(e, t, a) {
                function n(e, t, a) { e.addEventListener(t, a, !1) }
                Array.isArray(e) ? e.forEach(function(e) { n(e, t, a) }) : n(e, t, a)
            },
            removeEvent: function(e, t, a) {
                function n(e, t, a) { e.removeEventListener(t, a, !1) }
                Array.isArray(e) ? e.forEach(function(e) { n(e, t, a) }) : n(e, t, a)
            },
            empty: function(e) { for (; e.firstChild;) e.removeChild(e.firstChild) },
            createElem: function(e, t, a, n) { var r = document.createElement(e); return void 0 !== a && (r[n ? "innerHTML" : "innerText"] = a), void 0 !== t && D.setAttributes(r, t), r },
            setAttributes: function(e, t) { for (var a in t) e.setAttribute(a, t[a]) },
            setStyles: function(e, t) { for (var a in t) e.style[a] = t[a] },
            getDaysCount: function(e) { return new Date(e.getFullYear(), e.getMonth() + 1, 0).getDate() },
            dateDiff: function(e, t) { return Math.round((t - e) / 864e5) },
            screenDim: function() { var e = document.documentElement; return { height: Math.max(e.offsetHeight, e.clientHeight), width: Math.max(e.offsetWidth, e.clientWidth) } },
            ...
            extend: function(e) {
                ...
                for (; t < r; t++) {! function(e) { for (var t in e) Object.prototype.hasOwnProperty.call(e, t) && (n && "[object Object]" === Object.prototype.toString.call(e[t]) ? a[t] = D.extend(!0, a[t], e[t]) : a[t] = e[t]) }(arguments[t]) }
                return a
            },
            ...
            parseDate: function(a, e) {
                var n, t, r, d, i, o = void 0 === e ? this.config.format : e,
        ...
        s = function() {
            function g(e, t) {
                ...
                this._unbindInput = function() { a.input.readonly = !1, a.input.removeEventListener("click", p), a.input.removeEventListener("keydown", f), a.fromEl && (a.fromEl.readonly = !1, a.fromEl.removeEventListener("click", p), a.fromEl.removeEventListener("keydown", f)), a.toEl && (a.toEl.readonly = !1, a.toEl.removeEventListener("click", p), a.toEl.removeEventListener("keydown", f)) }, D.addEvent(a.input, "click", p), D.addEvent(a.input, "keydown", f), a.fromEl && (a.fromEl.readonly = !0, D.addEvent(a.fromEl, "click", p), D.addEvent(a.fromEl, "keydown", f)), a.toEl && (a.toEl.readonly = !0, D.addEvent(a.toEl, "click", p), D.addEvent(a.toEl, "keydown", f)), this._init(), this._setSelection()
            }
            var e, t, a;
            return e = g, (t = [{
                key: "_init",
                value: function() {
                    ...
                    n.config.inline || (D.appendTo([t.selectedYear, t.selectedDate], t.wrapper), D.appendTo(t.wrapper, e.wrapper), D.addEvent(t.selectedYear, "click", function() { "years" !== n.viewMode && n._switchView("years") }), D.addEvent(t.selectedDate, "click", function() {
                        var e = new Date,
                ...
                value: function(t) {
                    var a = this,
                        ...
                        l = 0 <= o.indexOf(c[t.getDay()]) || 0 <= o.indexOf(m[t.getDay()]) || 0 <= o.indexOf(m.map(function(e) { return e.substr(0, 2) })[t.getDay()]);
                ...
                value: function(e, t) {
                    for (var l = this, a = 1, n = new Date, r = new Date(n.getFullYear(), n.getMonth(), n.getDate()), d = l.config.range ? null : new Date(l.selected.year, l.selected.month, l.selected.date), i = l.rangeFrom ? new Date(l.rangeFrom.year, l.rangeFrom.month, l.rangeFrom.date) : null, o = l.rangeTo ? new Date(l.rangeTo.year, l.rangeTo.month, l.rangeTo.date) : null, s = new Date(e, t, a), c = D.getDaysCount(s), u = 1, m = [], p = 1; p <= 6; p++) {
                        ...
                        for (; a <= c;) {
                            ...
                            if (!(h < 6)) { l.config.range || s.getTime() !== d.getTime() || f[h].classList.add("selected"), l.config.range && i && s.getTime() === i.getTime() && f[h].classList.add("range-from"), l.config.range && o && s.getTime() === o.getTime() && f[h].classList.add("range-to"), f[h].innerText = a++; break }
                    ...
                    return m.forEach(function(e) {
                        for (var t = D.createElem("div", { class: "dudp__cal-week" }), a = 0; a < e.length; a++) {
                            ...
                            D.addEvent(n, "click", function() {
                                ...
                                }), this.classList.add("selected"), l.selected = { year: d, month: i, date: o }, l._setSelection(), l.config.auto && (l.date = a, l.setValue(l.date), l.hide())), l.datepicker.calendarHolder.wrapper.querySelectorAll(".dudp__month").forEach(function(e) {
                ...
                value: function() {
                    ...
                    var r = { wrapper: D.createElem("div", { class: "dudp__calendar" }), header: D.createElem("div", { class: "dudp__cal-month-year" }), weekDays: D.createElem("div", { class: "dudp__weekdays" }, p, !0), datesHolder: D.createElem("div", { class: "dudp__dates-holder" }) },
            ...
            }, { key: "formatDate", value: function(e, t) { return D.formatDate(e, t) } }, { key: "formatRange", value: function(e, t) { return this.config.events.onRangeFormat.call(this, e, t, this) } }, {
                key: "show",
                value: function() {
                    var c = this;
                    setTimeout(function() {
                ...
                value: function() {
                    var e = this;
                    e.datepicker.container.classList.add("dp__closing"), e.visible = !1, e.input.focus(), document.body.removeAttribute("datepicker-display"), setTimeout(function() { e._switchView("calendar"), e.datepicker.container.classList.remove("dp__closing", "dp__open"), e.config.events && e.config.events.hidden && e.config.events.hidden.call(e, e) }, 200)
                }
            }, { key: "destroy", value: function() { this._unbindInput(), document.body.removeChild(this.datepicker.container), delete this.input[o] } }]) && n(e.prototype, t), a && n(e, a), g
        }();
    return function() {
        var a = arguments,
            n = a[0],
